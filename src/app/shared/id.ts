...
export const ID: TranslationModel = {
 ...
 hero: {
  ...
  stack: {
    ...
    items: ['Angular', 'TypeScript', 'JavaScript', 'Tailwind', 'HTML/CSS', 'Bootstrap', 'DevExtreme', 'Ionic', 'Git', 'Docker', 'Chart.js', 'Figma']
  },
  projects: {
    ...
    items: [
      { 
        ...
        desc: 'Berkontribusi dalam pengembangan website model ERP dan optimasi UI/UX.', 
        tech: ['HTML', 'CSS', 'JavaScript'] 
      },
      { 
        name: 'Aplikasi Nasabah Bank Sampah', 
        desc: 'Aplikasi Android untuk manajemen nasabah bank sampah menggunakan metode Iterative Incremental.', 
